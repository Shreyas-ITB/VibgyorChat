...
app.run(['$rootScope', '$location', 'AuthService', 'ThemeService', function($rootScope, $location, AuthService, ThemeService) {
  ...
  $rootScope.$on('$routeChangeStart', function(event, next, current) {
    ...
    if (next.$$route && next.$$route.originalPath !== '/login' && next.$$route.originalPath !== '/auth/google/callback' && next.$$route.originalPath !== '/onboarding' && !next.$$route.originalPath.startsWith('/invite/')) {
